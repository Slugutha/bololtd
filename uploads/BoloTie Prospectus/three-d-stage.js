...
(() => {
  ...
  class ThreeDStage extends HTMLElement {
    ...
    resetView(duration = 600) {
      ...
      this._flyToView(this._homeDir.x, this._homeDir.y, this._homeDir.z, duration);
    ...
    setObject(object) {
      ...
      if (!box.isEmpty()) {
        ...
        const dir = new THREE.Vector3(-0.39, -0.42, 1.49).normalize();
        ...
        this._homeDir = { x: 1, y: 0.55, z: 1.25 };
